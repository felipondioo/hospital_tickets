    ...
    <body>
        ...
        <div class="container-wrapper">
            <div class="container-body">
                ...
                ?>
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Mantenimiento</label>
                ...
                <div class="mb-3">
                    ...
                    <br>
                    <textarea class="form-control" rows="2" id="descripcion" placeholder="Describa los avances / Comentarios aquí."></textarea>
                </div>

                <div class="d-flex justify-content-center">
                    <button id="modificar" class="btn btn-success">Enviar seguimiento</button>
                </div>
            </div>
        </div>
        ...
        <script src="../../funciones/modMantenimientoCurso.js"></script>
        <script>
