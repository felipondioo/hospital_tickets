...
<html lang="en">
    ...
    <body>
        ...
        <div class="container container-body">
            <a class="btn btn-danger" href="nmEncargado.php" role="button" style="text-decoration: none; color:white; font-size:17px; margin-right:auto;">
        ...
        <script src="../../funciones/historialSolicAdmin.js"></script>
        <script>
