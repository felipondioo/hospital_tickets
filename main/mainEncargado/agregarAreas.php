...
<body>
        ...
        <div class="row">
            <div class="col-md-8 mx-auto">
                <div class="container-body">
                    <div class="form-group form-container">
                        ...
                        <br>
                        <center><h2 class="titulo mb-4" style="font-weight: 400;">Crear Áreas</h2></center>
                        <div class="input-group">
                            <input type="text" id="area" placeholder="Nombre del área" class="form-control">
            ...
            <div class="col-md-8 mx-auto">
                <div id="contenedorTabla" class="container-body2">
                    <center><h3 class="titulo" style="font-weight: 400;">Áreas existentes</h3></center>
                    <br>
    ...
    <script src="../../funciones/crearArea.js"></script>
    <script>
        // $(document).ready(function() {
        //     // Aquí cargas dinámicamente los datos en la tabla, reemplaza este ejemplo con tu lógica
        //     var data = [
        //         [1, "Área 1", "<button class='btn btn-primary'>Editar</button>"],
        //         [2, "Área 2", "<button class='btn btn-primary'>Editar</button>"],
        //         [3, "Área 3", "<button class='btn btn-primary'>Editar</button>"]
