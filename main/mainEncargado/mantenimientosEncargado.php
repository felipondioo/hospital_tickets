...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="../../css/mantenimientosEncargado.css">
        <link rel="icon" href="../../imagenes/cropped-ICONO-1-32x32.png">
        <title>Mantenimientos >> Devoluciones</title>
    </head>
    <body>
        ...
        <div class="container container-body">
            <a class="btn btn-danger" href="mcEncargado.php" role="button" style="text-decoration: none; color:white; font-size:17px; margin-right:auto;">
        ...
        <script src="../../funciones/mantenimientosEncargado.js"></script>
        <script>
