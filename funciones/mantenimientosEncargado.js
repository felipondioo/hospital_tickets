$(document).ready(function() {
            ...
            success: function(response) {
                ...
                mantenimientos.forEach(function(mantenimiento) {
                    ...
                    tablaHTML += `<tr>
                                    ...
                                    <td>
                                        <a href="modMantenimiento.php?id=${mantenimiento.id}" class="modificar btn btn-success btn-sm">
                                            Seguimiento
                                        </a>
                                    </td>
                                    <td>
    ...
    $(document).on('click', 'button.eliminar', function() {
        ...
        Swal.fire({
            title: '¿Estás seguro?',
            text: "¿Deseas finalizar este mantenimiento?",
            icon: 'warning',
